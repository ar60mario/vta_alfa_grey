...
public class AbonoBO {
    ...
    public List<Abono> getAbonosActivosPendientesOrdenadoByRubro10(Rubro rubro) throws Exception {
        ...
        try {
            abonos = dao.getAbonosActivosPendientesOrdenadoByRubro10(rubro);
        } catch (HibernateException ex) {
            throw new Exception(ex);
        }
    ...
    public List<Abono> getAbonosActivosPendientesByRubroTipoFc3(Rubro rubro) throws Exception {
        ...
        List<Abono> abonos2 = new ArrayList<>();
        try {
            abonos = dao.getAbonosActivosPendientesByRubroTipoFc3(rubro);
        } catch (HibernateException ex) {
            throw new Exception(ex);
        }
        if (abonos != null && !abonos.isEmpty()) {
...
//        List<Abono> abonos2 = new ArrayList<>();
        try {
            abonos = dao.getAbonosActivosPendientesOrdenadoByRubro4(rubro);
        } catch (HibernateException ex) {
            throw new Exception(ex);
        }
        return abonos;
...
//        List<Abono> abonos2 = new ArrayList<>();
        try {
            abonos = dao.getAbonosActivosPendientesOrdenadoByRubro7(rubro);
        } catch (HibernateException ex) {
            throw new Exception(ex);
        }
        return abonos;
...
//        List<Abono> abonos2 = new ArrayList<>();
        try {
            abonos = dao.getAbonosActivosPendientesOrdenadoByRubro8(rubro);
        } catch (HibernateException ex) {
            throw new Exception(ex);
        }
        return abonos;
