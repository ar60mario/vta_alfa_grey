...
public class AbonoService {
    ...
    public List<Abono> getAbonosActivosPendientesOrdenadoByRubro10(Rubro rubro) throws Exception {
        ...
        List<Abono> abonos = null;
        try {
            abonos = new AbonoBO().getAbonosActivosPendientesOrdenadoByRubro10(rubro);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public List<Abono> getAbonosActivosPendientesByRubroTipoFc3(Rubro rubro) throws Exception {
        ...
        List<Abono> abonos = null;
        try {
            abonos = new AbonoBO().getAbonosActivosPendientesByRubroTipoFc3(rubro);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public List<Abono> getAbonosActivosPendientesOrdenadoByRubro7(Rubro rubro) throws Exception {
        ...
        List<Abono> abonos = null;
        try {
            abonos = new AbonoBO().getAbonosActivosPendientesOrdenadoByRubro7(rubro);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public List<Abono> getAbonosActivosPendientesOrdenadoByRubro8(Rubro rubro) throws Exception {
        ...
        List<Abono> abonos = null;
        try {
            abonos = new AbonoBO().getAbonosActivosPendientesOrdenadoByRubro8(rubro);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
