...
import ar.com.ventas.BO.FondoReciboBO;
...
public class FondoReciboService {
    ...
    public List<FondoRecibo> getAllFondoRecibosActivos() throws Exception {
        ...
        try {
            fondos = new FondoReciboBO().getAllFondoRecibosActivos();
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
    ...
    public List<FondoRecibo> getAllFondoRecibosInactivos() throws Exception {
        ...
        Transaction tx = session.beginTransaction();
        try {
            fondos = new FondoReciboBO().getAllFondoRecibosInactivos();
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public Integer getCodigoSiguiente() throws Exception {
        ...
        Transaction tx = session.beginTransaction();
        try {
            codigo = new FondoReciboBO().getCodigoSiguiente();
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public FondoRecibo saveFondoRecibo(FondoRecibo fondo) throws Exception {
        ...
        Transaction tx = session.beginTransaction();
        try {
            fondo = new FondoReciboBO().saveFondoRecibo(fondo);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public FondoRecibo updateFondoRecibo(FondoRecibo fondo) throws Exception {
        ...
        Transaction tx = session.beginTransaction();
        try {
            fondo = new FondoReciboBO().updateFondoRecibo(fondo);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
    ...
    public FondoRecibo getFondoReciboByTitular2(TitularCuit titu) throws Exception {
        Session session = HibernateUtils.getSessionFactory().getCurrentSession();
        Transaction tx = session.beginTransaction();
        FondoRecibo fondo = null;
        try {
            fondo = new FondoReciboBO().getFondoReciboByTitular2(titu);
            tx.commit();
        } catch (Exception ex) {
            tx.rollback();
            throw new Exception(ex);
