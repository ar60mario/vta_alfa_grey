...
//        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        cuotaTxt.setText("CTA");
        cuotaTxt.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cuotaTxtKeyPressed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(deTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel3)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(alTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel6)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(cuotaTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(adminTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 295, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void cuotaTxtKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cuotaTxtKeyPressed
        if (evt.getKeyCode() == 10) {
//            if (!cuotaTxt.getText().isEmpty()) {
                importeTxt.requestFocus();
//            }
        }
    }//GEN-LAST:event_cuotaTxtKeyPressed
    ...
    private void buscar() {
        ...
        if (!cuotaTxt.getText().isEmpty()) {
            cuota = Integer.valueOf(cuotaTxt.getText().replace(",", "."));
        }
        Date de; // = new Date();
        Date al; // = new Date();
        try {
        ...
        try {
            if (rowR < 1) {
                ...
                if (ru.getId().equals(2L)) { // tanques
                    if(cuota.equals(0)){
                        JOptionPane.showMessageDialog(this, "INDIQUE UNA CUOTA PARA LIMP.TANQUES");
                        cuotaTxt.requestFocus();
                        return;
                    }
                    fcs = new ComprobanteService()
                            .getComprobantesEntrFechasAndRubroOrdenConsoParaAsignarCuotaImporte(de, al,
                                    ru, cuota, importe);
                }
                if (ru.getId().equals(4L)) { // fumigación
                    fcs = new ComprobanteService()
                            .getComprobantesEntreFechasAndRubroOrdenConsoParaAsignarImporte(de, al, ru, importe);
                }
            }
        } catch (Exception ex) {
            Logger.getLogger(AsignarFacturaFrame.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "ERROR Nro. 461 - COMPROBANTES");
            return;
        }
...
//        }
    ...
    private void llenarCombo() {
        ...
        if (row > -1) {
            ...
            JOptionPane.showMessageDialog(this, "DEBE SELECCIONAR UN COMPROBANTE PRIMERO");
            return;
        }
...
//                System.out.println(dm.getNumero());
    ...
    private void asignar() {
        ...
        if (row < 1) {
            JOptionPane.showMessageDialog(this, "SELECCIONE UN RUBRO PARA ASIGNAR");
            return;
        }
        if (row0 < 0) {
