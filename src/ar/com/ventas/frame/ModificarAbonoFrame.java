...
public class ModificarAbonoFrame extends javax.swing.JFrame {
     ...
     * @param abonos
     */
    public ModificarAbonoFrame(Abono abono, Integer rowR, Integer rowA, Integer row, List<Abono> abonos) {
        initComponents();
...
//        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jLabel13.setText("FECHA PERIODO:");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(comboC, javax.swing.GroupLayout.PREFERRED_SIZE, 525, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(comboR, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(jLabel7)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(comboTf, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(pendienteChk)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel13)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(fechaPeriodoTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(comboPe, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarAbonoFrame(null, null, null, null, null).setVisible(true);
            }
        });
    }
    ...
    private void volver() {
        AbmAbonosFrame mf = new AbmAbonosFrame(rowR, rowA, row, abonos);
        mf.setVisible(true);
        this.dispose();
    }
    ...
    private void grabar() {
        if (verificar()) {
            ...
            try {
                ...
                fechaPe = sdf.parse(fechaPeriodoTxt.getText());
            ...
            int cod = ru.getCodigo();
            if (cod == 3) {
                if (rowPe < 1) {
                    JOptionPane.showMessageDialog(this, "DEBE ASIGNARTE UN TEXTO DE PERIODO\nA ESTE RUBRO");
                    return;
                }
            }
...
//        Rubro rub = abono.getRubro();
        Consorcio cons = abono.getConsorcio();
        String cuit = cons.getCuit();
//        System.out.println(cuit);
//        System.exit(0);
        if (cuit.equals("00-00000000-0")) {
            if (!pendienteChk.isSelected() || !activoChk.isSelected()) {
                Comprobante compr;
                try {
                    compr = new ComprobanteService().getUltimoComprobanteByConsorcioAndRubro(cons, rubro);
                } catch (Exception ex) {
                    Logger.getLogger(ModificarAbonoFrame.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(this, "ERROR 741 - COMPROBANTES");
                    return false;
                }
                if (compr.getOriginal()) {
                    JOptionPane.showMessageDialog(this, "VERIFIQUE CONSORCIO ORIGINAL");
                    int a = JOptionPane.showConfirmDialog(this, "Texto a confirmar", 
...
//        System.out.println(renglones2);
        ...
        if (abono.getFechaPeriodo() != null) {
            fechaPeriodoTxt.setText(sdf.format(abono.getFechaPeriodo()));
        } else {
