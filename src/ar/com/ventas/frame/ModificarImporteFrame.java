 ...
 * @author Mario
 */
public class ModificarImporteFrame extends javax.swing.JFrame {
     ...
     */
    public ModificarImporteFrame(Importe importe) {
        initComponents();
...
//        setExtendedState(this.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        setTitle("MODIFICAR IMPORTE DE TRABAJO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarImporteFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarImporteFrame(null).setVisible(true);
            }
        });
    }
    ...
    private void guardar() {
        if (validar()) {
            if (activoChk.isSelected()) {
                ...
                importe.setActivo(false);
            }
            importe.setDetalle(detalleTxt.getText());
            Double dob = Double.valueOf(precioTxt.getText().replace(",", "."));
            importe.setImporte(dob);
            try {
                new ImporteService().updateImporte(importe);
                JOptionPane.showMessageDialog(this, "IMPORTE DE TRABAJO GUARDADO CORRECTAMENTE");
            } catch (Exception ex) {
                Logger.getLogger(ModificarImporteFrame.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "ERROR Nro. 193 GUARDANDO IMPORTE DE TRABAJO");
                return;
            }
            volver();
        }
    ...
    private void volver() {
        AbmImportesFrame apf = new AbmImportesFrame();
        apf.setVisible(true);
        this.dispose();
    }
    ...
    private void llenarCampos() {
        detalleTxt.setText(importe.getDetalle());
        precioTxt.setText(df.format(importe.getImporte()));
        if (importe.getActivo()) {
