 ...
 * @author Mario
 */
public class NuevoImporteFrame extends javax.swing.JFrame {

    /**
     * Creates new form NuevoPrecioFrame
     */
    public NuevoImporteFrame() {
        initComponents();
//        setExtendedState(this.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        setTitle("NUEVO IMPORTE DE TRABAJO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoImporteFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoImporteFrame().setVisible(true);
            }
        });
    }
    ...
    private void guardar() {
        if(validar()){
            Integer codigo = 0;
            try {
                codigo = new ImporteService().getImporteSiguiente();
            } catch (Exception ex) {
                Logger.getLogger(NuevoImporteFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
            Importe p = new Importe();
            p.setCodigo(codigo);
            p.setActivo(true);
            p.setDetalle(detalleTxt.getText());
            Double dob = Double.valueOf(precioTxt.getText());
            p.setImporte(dob);
            try {
                new ImporteService().saveImporte(p);
                JOptionPane.showMessageDialog(this, "IMPORTES DE PAGO GUARDADO CORRECTAMENTE");
            } catch (Exception ex) {
                Logger.getLogger(NuevoImporteFrame.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "ERROR Nro. 193 GUARDANDO IMPORTES DE PAGO");
                return;
            }
            volver();
        }
