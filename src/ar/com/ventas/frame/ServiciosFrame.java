 ...
 * @author Mario
 */
public class ServiciosFrame extends javax.swing.JFrame {
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(comboC, 0, 550, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ServiciosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ServiciosFrame().setVisible(true);
            }
        });
    }
    ...
    private void nuevo() {
        ...
        if (rowC > 0) {
            if (rowR > 0) {
                ...
                JOptionPane.showMessageDialog(this, "INGRESE UN RUBRO PARA EL NUEVO TRABAJO");
            }
        }else{
            JOptionPane.showMessageDialog(this, "SELECCIONE UN CONSORCIO PARA EL NUEVO TRABAJO");
        }
    }
    ...
    private void modificar() {
        ...
        if (rowC > 0) {
            if (rowR > 0) {
                ModificarServicioFrame ntf = new ModificarServicioFrame(t);
                ntf.setVisible(true);
                this.dispose();
            }
        }
    ...
    private void llenarCombos() {
        ...
        try {
            ...
            Logger.getLogger(ServiciosFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        rubros = null;
        try {
    ...
    private void llenarTabla() {
        ...
        limpiarTabla();
        int rowC = comboC.getSelectedIndex();
        int rowS = comboR.getSelectedIndex();
        if (rowC > 0) {
            if (rowS > 0) {
                Consorcio co = consorcios.get(rowC - 1);
                Rubro ru = rubros.get(rowS - 1);
                try {
                    //servicios = new ServicioService().getAllServiciosActivosByRubroAndConsorcio(ru, co);
                } catch (Exception ex) {
                    Logger.getLogger(ServiciosFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void inactivos() {
        ServiciosInactivosFrame tif = new ServiciosInactivosFrame();
        tif.setVisible(true);
        this.dispose();
    }
}
