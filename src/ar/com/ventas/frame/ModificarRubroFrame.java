...
//        setExtendedState(this.MAXIMIZED_BOTH);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                            .addComponent(importeTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 141, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGap(18, 18, 18)
                            ...
                            .addComponent(textoEnFacturaTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 678, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void llenarCombo() {
        ...
        Long row = rubro.getEstructura().getId();
        int p = 1;
        int es = 0;
        for (Estructura e : estructuras) {
            System.out.println(e.getId());
            System.out.println(row);
            if (row.equals(e.getId())) {
                es = p;
                break;
            }
            p += 1;
        }
        combo.setSelectedIndex(es);
    }
    ...
    private void llenarCampos() {
        ...
        importeTxt.setText(df.format(rubro.getImporte()));
        ...
        if(rubro.getEsAbono() != null){
            if(rubro.getEsAbono()){
                esAbonoChk.setSelected(true);
            } else {
