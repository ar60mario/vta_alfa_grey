 ...
 * @author argia
 */
public class VerComprobante3Frame extends javax.swing.JFrame {
     ...
     * @param al
     */
    public VerComprobante3Frame(Comprobante comprobante, Consorcio co, Date de, Date al) {
        initComponents();
...
//        setExtendedState(this.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        numeroCpbteTxt = new javax.swing.JTextField();
        fechaCpbteTxt = new javax.swing.JTextField();

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        setTitle("NOTA DE CÉDITO");
        ...
        jLabel11.setText("COMP. ORIGEN:");

        jLabel12.setText("FECHA CPBTE. ORIGEN:");

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel13.setText("NOTA DE CRÉDITO");

        numeroCpbteTxt.setText("NUMERO");

        fechaCpbteTxt.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        fechaCpbteTxt.setText("FECHA 2");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(numeroCpbteTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(fechaCpbteTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel11)
                    .addComponent(jLabel12)
                    .addComponent(numeroCpbteTxt, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerComprobante3Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerComprobante3Frame(null, null, null, null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField numeroCpbteTxt;
    ...
    private void llenarFrame() {
        ...
        Comprobante comp2 = null;
        Integer tipoCompAsoc = comprobante.getTipoComprobanteAsociado();
        Integer SucuCmpbteAsoc = comprobante.getSucursalComprobanteAsociado();
        Integer NumCmpbteAsoc = comprobante.getNumeroComprobanteAsociado();
        try {
            comp2 = new ComprobanteService().getComprByNroSucAndTipo(NumCmpbteAsoc, SucuCmpbteAsoc, tipoCompAsoc);
        } catch (Exception ex) {
            Logger.getLogger(VerComprobante3Frame.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        numeroCpbteTxt.setText("");
        fechaCpbteTxt.setText("");
        if (comp2 != null) {
            String nf2 = comprobante.getLetraComprobanteAsociado() + " "
                    + dfs.format(comprobante.getSucursalComprobanteAsociado()) + "-"
                    + dfn.format(comprobante.getNumeroComprobanteAsociado());
            numeroCpbteTxt.setText(nf2);
            fechaCpbteTxt.setText(sdf.format(comp2.getFecha()));
        }
    }
