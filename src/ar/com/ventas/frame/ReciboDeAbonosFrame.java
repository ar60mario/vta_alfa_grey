 ...
 * @author Mario
 */
public class ReciboDeAbonosFrame extends javax.swing.JFrame {
...
//go();
    ...
    private void initComponents() {
        ...
        setTitle("RECIBOS DE ABONOS POR RUBRO");
        ...
        generarFacturasBtn.setText("Generar Recibo X");
        ...
        jLabel5.setText("FILTRO TITULARES PARA FONDO:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(comboT, javax.swing.GroupLayout.PREFERRED_SIZE, 402, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                .addGap(18, 18, 18)
                                                .addComponent(filtroTitularTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                    .addGroup(layout.createSequentialGroup()
...
//            llenarTabla2(row);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReciboDeAbonosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReciboDeAbonosFrame().setVisible(true);
            }
        });
    }
    ...
    private void llenarCombo() {
        ...
        try {
            ...
            Logger.getLogger(ReciboDeAbonosFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//                fecha_vencim = sdf.parse(vtoTxt.getText());
            ...
            FondoRecibo fr = null;
            try {
                fr = new FondoReciboService().getFondoReciboByTitular2(titular);
            } catch (Exception ex) {
                Logger.getLogger(ReciboDeAbonosFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
            if (fr != null) {
...
//                    } else {
//                        x_comprobante = cni.getNroCpbte();
//                        x_comprobante += 1;
//                        cni.setNroCpbte(x_comprobante);
//                        new ComprobanteNumerosInicialesService().saveImporte(cni);
//                    }
//                } catch (Exception ex) {
//                    Logger.getLogger(ReciboDeAbonosFrame.class.getName()).log(Level.SEVERE, null, ex);
//                    return;
                ...
                for (Abono ab : abonos) {
                    ...
                    if (tipoFact.equals(2)) { // 1 Factura por Mes
                        ...
                        if (ra != null && !ra.isEmpty()) {
                            for (RenglonAbono r_a : ra) {
                                ComprobanteRenglones cre = new ComprobanteRenglones();
                                cre.setDetalle(r_a.getTexto());
                                cre.setImporte(r_a.getImporte());
                                renglones.add(cre);
                            }
...
//                                ab, ra, fecha, fecha_periodo_dde, fecha_periodo_hta, fecha_vencim, ps);
                            String resultado = UtilFactura.saveReciboAbono(ab, consorcio, fr, renglones, importe_abono, rubro, fecha, fecha, ps, ab.getCuotaFacturada()+1, ab.getCuotas());
                            System.out.println(resultado);
                        } else {
                            JOptionPane.showMessageDialog(this, "ERROR EN RENGLONES ABONO");
                            return;
                        }
                    }
...
//                    }
                ...
                JOptionPane.showMessageDialog(this, "RECIBOS COMPLETADOS");
            } else {
                JOptionPane.showMessageDialog(this, "ERROR EN FONDO RECIBO");
            }
            volver();
...
//    }
    ...
    private void limpiarCampos() {
        ...
        alTxt.setVisible(false);
        vtoTxt.setVisible(false);
        alTxt.setText("");
