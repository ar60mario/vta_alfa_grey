...
//        setExtendedState(6); // this.MAXIMIZED_BOTH
    ...
    private void initComponents() {
        ...
        pendienteFacturarBtn = new javax.swing.JButton();
        ...
        pendienteFacturarBtn.setText("Sacar Abono Pendiente de Facturar");
        pendienteFacturarBtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pendienteFacturarBtnActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(pendienteFacturarBtn)
                        .addGap(18, 18, 18)
...
//        }
    ...
    private void pendienteFacturarBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pendienteFacturarBtnActionPerformed
        sacarAbonoPendiente();
    }//GEN-LAST:event_pendienteFacturarBtnActionPerformed
    ...
    private javax.swing.JButton pendienteFacturarBtn;
    ...
    private void baja() {
        ...
        if (a == 0) {
            try {
                ...
                Logger.getLogger(RenovarAbonosVencidosFrame.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "ERROR 416 - ABONO");
                return;
            }
            ConsorcioMaster cm = null;
            try {
                ...
                Logger.getLogger(RenovarAbonosVencidosFrame.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "ERROR 424 - CONSORCIO MASTER");
                return;
            }
...
//            String master = obtenerMaster(c, ru);
    ...
    private void sacarAbonoPendiente() {
        int rowA = tabla.getSelectedRow();
        int rowR = combo.getSelectedIndex();
        if (rowA < 0) {
            JOptionPane.showMessageDialog(this, "SELECCIONE UN ABONO PARA SACAR PENDIENTE");
            return;
        }
        if (rowR < 1) {
            JOptionPane.showMessageDialog(this, "DEBE SELECCIONAR RUBRO");
        ...
        Domicilio dm = con.getDomicilio();
        String calle = dm.getCalle() + " " + dm.getNumero();
        int a = JOptionPane.showConfirmDialog(this, "CONFIRA SACAR PENDIENTE AL ABONO\n" + calle, "Atención", JOptionPane.YES_NO_OPTION);
        if (a == 0) {
            try {
                new AbonoService().updateAbono(abo);
            } catch (Exception ex) {
