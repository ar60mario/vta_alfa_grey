 ...
 * @author Mario
 */
public class NuevoHijoFrame extends javax.swing.JFrame {
     ...
     * @param persona
     */
    public NuevoHijoFrame(Persona persona, Integer h) {
        initComponents();
...
//        setExtendedState(this.MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoHijoFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoHijoFrame(null, null).setVisible(true);
            }
        });
    }
    ...
    private void limpiarCampos() {
        ...
        dniTxt.setText("");
        cuilTxt.setText("");
        apellidoNombreOtroPadreTxt.setText("");
    }
    ...
    private void guardar() {
        if (validar()) {
            ...
            try {
                ...
                Logger.getLogger(NuevoHijoFrame.class.getName()).log(Level.SEVERE, null, ex);
