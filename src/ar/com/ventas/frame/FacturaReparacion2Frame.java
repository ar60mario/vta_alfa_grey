 ...
 * @author Mario
 */
public class FacturaReparacion2Frame extends javax.swing.JFrame {
     ...
     */
    public FacturaReparacion2Frame() {
        initComponents();
...
//                    tabla = UtilFrame.agregarLinea(tabla);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FacturaReparacion2Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FacturaReparacion2Frame().setVisible(true);
            }
        });
    }
...
//            Double iva = 0.0;
//            Double total = 0.0;
//            nuevo = UtilFrame.enviarFacturaAfip(titular, cuitCliente, gravado, iva, total);
//            a = nuevo.getEstado();
//            if (a.equals("A")) {
//                e = UtilFrame.registrarComprobanteReparaion(nuevo, titular, consorcio, gravado, iva, total, renglones, cuotas);
//            }
//            if (e == 1) {
////                crearPdf(nuevo, titular, consorcio, gravado, iva, total, renglones, cuotas);
//            } else {
//                JOptionPane.showMessageDialog(this, "ERROR REGISTRANDO COMPROBANTE");
//                return;
//            }
