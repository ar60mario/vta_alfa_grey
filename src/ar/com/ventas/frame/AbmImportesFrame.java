 ...
 * @author Mario
 */
public class AbmImportesFrame extends javax.swing.JFrame {
...
//        setExtendedState(this.MAXIMIZED_BOTH);
    ...
    private void initComponents() {
        ...
        setTitle("ABM IMPORTES DE PAGO DE TRABAJOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbmImportesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbmImportesFrame().setVisible(true);
            }
        });
    }
    ...
    private void llenarTabla() {
        ...
        try {
            ...
            Logger.getLogger(AbmImportesFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void nuevo() {
        NuevoImporteFrame npf = new NuevoImporteFrame();
        npf.setVisible(true);
        this.dispose();
    }
    ...
    private void modificar() {
        ...
        if (row < 0) {
            JOptionPane.showMessageDialog(this, "DEBE SELECCIONAR UN PRECIO A MODIFICAR");
            return;
        }
        Importe importe = importes.get(row);
        ModificarImporteFrame mpf = new ModificarImporteFrame(importe);
        mpf.setVisible(true);
        this.dispose();
    }

    private void inactivos() {
        ImportesInactivosFrame pif = new ImportesInactivosFrame();
        pif.setVisible(true);
        this.dispose();
    }
