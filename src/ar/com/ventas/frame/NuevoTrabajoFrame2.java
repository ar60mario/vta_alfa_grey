 ...
 * @author Mario
 */
public class NuevoTrabajoFrame2 extends javax.swing.JFrame {
    ...
    private void comboSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_comboSActionPerformed
        if (evt.getModifiers() == 16) {
            ...
            if (rowS > 0) {
                ...
                Consorcio consorcio = consorcios.get(rowC);
                rubro = rubros.get(rowS);
        ...
        if (evt.getKeyCode() == 10) {
            ...
            if (largo == 10) {
                ...
                try {
                    ...
                    Logger.getLogger(NuevoTrabajoFrame2.class.getName()).log(Level.SEVERE, null, ex);
...
//                verificarServicio();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoTrabajoFrame2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoTrabajoFrame2().setVisible(true);
            }
        });
    }
...
//            rubro.setCaracteristicas(caracteristicas);
...
//        }
    ...
    private void llenarComboS() {
        ...
        rubros = null;
        try {
//            rubros = new ServicioService().getAllServiciosActivos();
        } catch (Exception ex) {
            Logger.getLogger(NuevoTrabajoFrame2.class.getName()).log(Level.SEVERE, null, ex);
        }
        comboS.removeAllItems();
...
//                comboS.addItem(t.getRubro().getDetalle());
//            }
//            comboS.requestFocus();
...
//        }
    ...
    private Boolean verificarServicio(Consorcio consorcio) {
