...
//        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "CONSORCIO", "CUIT", "CTA FCTRD", "IMPORTE", "CONS ORG", "ADMIN", "TITULAR", "ID_ORG", "ID_MST"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Object.class, java.lang.Object.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class
            };
...
//                }
                try {
                    ...
                    Logger.getLogger(AbonosPendientesFacturarFrame.class.getName()).log(Level.SEVERE, null, ex);
                    JOptionPane.showMessageDialog(this, "ERROR CPBTE");
                    return;
...
//                        System.out.println(consorcioVinculado.getId());
//                        System.out.println(comprobanteMaster.getId());
//                        System.out.println(ab.getConsorcio().getId());
//                        System.out.println(comprobanteMaster.getOriginal());
//                        System.out.println(comprobanteMaster.getId_original());
//                        
////                        System.exit(0);
////                        System.out.println(consorcioVinculado.getDomicilio().getCalle());
////                        System.out.println(r.getDetalle());
//                        System.out.println(codi);
                        try {
//                            System.out.println(consorcioVinculado.getId());
//                            System.out.println(r.getId());
                            comprobante2 = new ComprobanteService().getComprobantesByConsorcioAndRubro(consorcioVinculado, r);
                        } catch (Exception ex) {
                            Logger.getLogger(AbonosPendientesFacturarFrame.class.getName()).log(Level.SEVERE, null, ex);
                            comprobante2 = null;
//                            JOptionPane.showMessageDialog(this, "ERROR 486 - COMPROBANTE ORIGINAL");
//                            return;
                        }
                    }
...
//                String reasignar = "REASIGNAR";
                if(comprobante2 != null){
                    ap.setComprobanteMaster(comprobante2);
                } else {
                    ap.setComprobanteMaster(null);
                }
...
//    COMPROBANTES ASIGNADOS SEGUNDO
            for (AbonoPendiente ap : abonosPendientes) {
                Comprobante compro = ap.getComprobante();
                Comprobante compro2 = ap.getComprobanteMaster();
...
//                        Logger.getLogger(FacturarAbonosFrame.class.getName()).log(Level.SEVERE, null, ex);
                        ...
                        Domicilio dm = cns.getDomicilio();
                        String calle = dm.getCalle() + " " + dm.getNumero();
                        JOptionPane.showMessageDialog(this, "ERROR RECUPERANDO RENGLONES DE FACTURA\n" + calle + "\nTOME NOTA");
                        continue;
                    }
                    ...
                    Double toRengl = 0.0;
                    for (RenglonAbono ren : ra) {
                        toRengl += ren.getImporte();
                    }
                    String str1 = df.format(compro2.getTotal());
                    String str2 = df.format(toRengl);
                    if (!str1.equals(str2)) {
                        System.out.println(compro2.getTotal());
                        System.out.println(toRengl);
                        System.out.println(ap.getComprobanteMaster().getId());
                        System.out.println(ap.getComprobanteMaster().getTotal());
                        Consorcio cns = ab.getConsorcio();
                        Domicilio dm = cns.getDomicilio();
                        String calle = dm.getCalle() + " " + dm.getNumero();
                        JOptionPane.showMessageDialog(this, "NO COINCIDEN TOTALES RENGLONES Y FACTURA\n" + calle + "\nTOME NOTA");
                        continue;
                    }
                    ab.setPendiente(false);
                    ...
                    if (!resultado.equals("A")) {
                        ...
                        Domicilio dm = cns.getDomicilio();
                        String calle = dm.getCalle() + " " + dm.getNumero();
                        JOptionPane.showMessageDialog(this, "ERROR VINCULANDO " + resultado + "\n" + calle + "\nTOME NOTA");
                        continue;
                    }
    ...
    private void llenarTabla(List<AbonoPendiente> abonosP) {
        ...
        if (abonosP != null && !abonosP.isEmpty()) {
            ...
            for (AbonoPendiente ap : abonosP) {
                ...
                o[6] = adm.getNombreAdministrador();
                String calle = dm.getCalle() + " " + dm.getNumero();
